    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="min-h-[600px]">
        {activeTab === 'categories' ? (
          ...
          <div className="flex flex-col items-center justify-center h-[500px] bg-white rounded-3xl border border-dashed border-stone-200 animate-in zoom-in-95 duration-500">
            <div className="w-16 h-16 rounded-2xl bg-stone-50 flex items-center justify-center text-stone-200 mb-6">
              <FiBox size={32} />
            </div>
            <h4 className="text-lg font-black text-stone-900 tracking-tight mb-2">
              Tính năng Sản phẩm đang phát triển
            </h4>
