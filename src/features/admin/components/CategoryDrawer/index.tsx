...
const CategoryFormDrawer = ({
  ...
  if (isOpen !== prevIsOpen || selectedCategory !== prevCategory) {
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 w-full max-w-xl bg-white h-full shadow-2xl z-70 flex flex-col font-sans"
          >
