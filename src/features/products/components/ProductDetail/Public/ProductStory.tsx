    ...
    <section className="py-8 border-t border-stone-100 overflow-hidden">
      <div className="flex flex-col gap-10">
        ...
        <div className="max-w-4xl mx-auto text-center px-6">
          <p className="text-green-700 font-black uppercase tracking-[0.4em] text-[10px] mb-4">
            Câu chuyện sản phẩm
          </p>
          <h2 className="text-2xl md:text-3xl font-black text-stone-900 tracking-tighter leading-tight mb-6">
        ...
        <div className="flex flex-col gap-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="relative aspect-4/5 rounded-[2.5rem] overflow-hidden shadow-xl skew-y-1 hover:skew-y-0 transition-transform duration-700">
              <Image
            ...
            <div className="flex flex-col gap-6 px-6">
              <Quote className="w-10 h-10 text-green-100 fill-green-100" />
              <div className="prose prose-stone prose-base max-w-none text-stone-700 font-medium leading-[1.65] tracking-tight">
                <p className="first-letter:text-6xl first-letter:font-black first-letter:text-green-700 first-letter:mr-2 first-letter:float-left first-letter:leading-none">
                  {paragraphs[0] ||
          ...
          <div className="relative py-14 bg-stone-900 rounded-[2.5rem] text-white overflow-hidden text-center px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div className="flex flex-col gap-6 px-6 order-2 lg:order-1">
              <div className="prose prose-stone prose-base max-w-none text-stone-600 font-medium leading-[1.65]">
            ...
            <div className="relative aspect-4/5 rounded-[2.5rem] overflow-hidden shadow-xl -skew-y-1 hover:skew-y-0 transition-transform duration-700 order-1 lg:order-2">
              <Image
