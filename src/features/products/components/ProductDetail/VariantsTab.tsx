              ...
              {variants.map((v) => (
                <tr key={v.id} className="hover:bg-stone-50/50 transition-colors">
                  ...
                  <td className="px-4 py-4 text-right">
                    <div className="font-black text-emerald-600">{formatCurrencyVND(v.price)}</div>
      ...
      {showForm ? (
        ...
        >
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <label htmlFor="isDefault" className="text-xs font-bold text-stone-700 cursor-pointer">
