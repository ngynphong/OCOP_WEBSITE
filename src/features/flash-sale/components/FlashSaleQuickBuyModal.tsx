          ...
          <div className="flex-1 p-8 overflow-y-auto custom-scrollbar">
            ...
            <div className="mt-8">
              <button
                ...
                className="w-full py-2 bg-red-600 hover:bg-red-700 disabled:bg-stone-200 disabled:text-stone-400 text-white rounded-2xl font-black text-md transition-all shadow-xl shadow-red-600/20 active:scale-[0.98] flex items-center justify-center gap-3"
              >
                {isSubmitting ? (
                  <>
